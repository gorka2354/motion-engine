...
**Мотивация:** Bybit-луп 2026-07-08 — тайлы весь ролик за границей кадра; одиночные stills в удачных фазах баг скрыли (грабля №6 в CLAUDE.md).
...
**Валидация:** прогнать на текущем BybitCardGif (должен пройти) и на намеренно сломанной версии (орбита 3.1 — должен упасть на content/motion-check).
