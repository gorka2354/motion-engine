 ...
 * brand-owned and deterministic. Replaces the raster assets the tixu screens
 ...
 * illustration in place of the tixu backpack render.
 */
 ...
 * the tixu lesson illustration (person → robot → system).
 */
