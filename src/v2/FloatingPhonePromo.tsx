...
/**
 * Brand-swappable dark stage the phone floats on. Each brand wrapper supplies
 * its own preset — see src/lumo for a worked example.
 */
 ...
 * Brand wrappers (see src/lumo) are thin and supply these.
 */
